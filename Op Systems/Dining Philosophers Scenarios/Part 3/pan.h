...
#define PanSource	"dining_phil3.pml"
...
#define Air0	(sizeof(P0) - Offsetof(P0, left) - 1*sizeof(int))
...
#define HAS_TRACK	0
/* hidden variable: */	uchar thinking[2];
/* hidden variable: */	uchar hungry[2];
/* hidden variable: */	uchar eating[2];
